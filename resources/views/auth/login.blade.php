...
<head>
  ...
  <title>SysLBL | Iniciar Sesion</title>
          ...
          <div class="authentication-form mx-auto">
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group">
                <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Correo Electronico" required="" value="{{ old('email') }}" name="email" id="email">
              ...
              <div class="form-group">
                <input type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password" required="" value="123456" name="password" id="password">
            ...
            <div class="register">
              <p>Todavia no tienes cuenta? <a href="{{ route('register') }}">Registrate</a></p>
            </div>
          </div>
        </div>
      </div>
